...
@section('content')
    ...
    <center style="font-size: x-large">{{$userData->name}}</center>
    <form method="POST" action="/admin/updateEmailName/{{$userData->id}}" class="ml-5">
        @method('PATCH')
        @csrf
        <div class="form-group row mt-5">
            ...
            <div class="col-md-4">
                <input id="name" type="text"
                       ...
                       value="{{ old('name') ?? $userData->name }}" autofocus>
