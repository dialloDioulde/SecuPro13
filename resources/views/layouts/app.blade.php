            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active"><a href="/admin/users" class="nav-link">Vacations</a></li>
                        <li class="nav-item active"><a href="/admin/usersDashboard" class="nav-link">Administration</a></li>
                    </ul>
